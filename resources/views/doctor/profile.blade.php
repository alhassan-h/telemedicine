                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4" id="fname" placeholder="First Name" value="{{$doctor->getFirstName()}}" name="first_name">
                                                                    @error('first_name')
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control mb-4" id="sex" name="gender">
                                                                        <option value="female" @selected($doctor->getGender() == 'female')>Female</option>
                                                                        <option value="male" @selected($doctor->getGender() == 'male')>Male</option>
                                                                    </select>
                                                                    @error('gender')
                                                                        <span class="d-flex invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <input type="text" class="form-control mb-4" placeholder=" Phone Number" id="phone" value="{{$doctor->getPhone()}}" name="phone">
                                                                @error('phone')
                                                                    <span class="d-flex invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4" id="email" placeholder="Email" value="{{$doctor->getEMail()}}" name="email" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="specialization">Specialization</label>
                                                                    <input type="text" class="form-control mb-4" id="specialization" placeholder=" Specialization" value="{{$doctor->getSpecialization()}}" name="specialization">
                                                                </div>
                                                            </div>                             
                                                            <div class="col-md-6">
                                                                <div class="form-group">
