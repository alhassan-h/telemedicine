...
Route::post('/profile', [App\Http\Controllers\DashboardController::class, 'profile'])->name('profile');
...
Route::post('/doctor/videochats/start', [App\Http\Controllers\DoctorController::class, 'startVideoCall'])->name('doctor.videochats.start');
Route::post('/doctor/videochats/end', [App\Http\Controllers\DoctorController::class, 'endVideoCall'])->name('doctor.videochats.end');
...
Route::post('/patient/profile/update', [App\Http\Controllers\PatientController::class, 'updateProfile'])->name('patient.profile.update');
